...
export const criteriaHierarchy: Record<string, Criterion> = {
  ...
  discipline: {
    ...
    level: 2,
    parentId: "admin",
    children: ["discipline_penalty", "discipline_referral"],
    isLeaf: false,
    type: "cost",
  ...
  discipline_penalty: {
    ...
    isLeaf: false,
    type: "cost",
    description: "Sürücünün aldığı disiplin cezalarının sayısı",
  },
  discipline_referral: {
    id: "discipline_referral",
    name: "Disipline Sevk Sayısı (Ceza Yok)",
    level: 3,
    parentId: "discipline",
    children: [
      "first_degree_referral",
      "second_degree_referral",
      "third_degree_referral", 
      "fourth_degree_referral",
    ],
    isLeaf: false,
    type: "cost",
    description: "Sürücünün disipline sevk edilme sayısı (ceza almayan)",
  },

  // Disiplin Cezası Alt Kriterleri (Seviye 4)
  first_degree_penalty: {
  ...
  // Disipline Sevk Alt Kriterleri (Seviye 4)
  first_degree_referral: {
    id: "first_degree_referral",
    name: "1. Derece Disiplin İhlali Sevk",
    level: 4,
    parentId: "discipline_referral",
    children: [],
    isLeaf: true,
    type: "cost",
    description: "En hafif disiplin ihlali sevk sayısı (ceza yok)",
    excelAliases: ["1. Derece Disiplin İhlali Sevk", "1'nci Derece Disiplin İhlali Sevk"],
  },
  second_degree_referral: {
    id: "second_degree_referral",
    name: "2. Derece Disiplin İhlali Sevk",
    level: 4,
    parentId: "discipline_referral",
    children: [],
    isLeaf: true,
    type: "cost",
    description: "Orta düzey disiplin ihlali sevk sayısı (ceza yok)",
    excelAliases: ["2. Derece Disiplin İhlali Sevk", "2'nci Derece Disiplin İhlali Sevk"],
  },
  third_degree_referral: {
    id: "third_degree_referral",
    name: "3. Derece Disiplin İhlali Sevk",
    level: 4,
    parentId: "discipline_referral",
    children: [],
    isLeaf: true,
    type: "cost",
    description: "Ciddi disiplin ihlali sevk sayısı (ceza yok)",
    excelAliases: [
      "3. Derece Disiplin İhlali Sevk",
      "3'ncü Derece Disiplin İhlali Sevk",
      "3'nci Derece Disiplin İhlali Sevk",
    ],
  },
  fourth_degree_referral: {
    id: "fourth_degree_referral",
    name: "4. Derece Disiplin İhlali Sevk",
    level: 4,
    parentId: "discipline_referral",
    children: [],
    isLeaf: true,
    type: "cost",
    description: "En ağır disiplin ihlali sevk sayısı (ceza yok)",
    excelAliases: [
      "4. Derece Disiplin İhlali Sevk",
      "4'ncü Derece Disiplin İhlali Sevk",
      "4'nci Derece Disiplin İhlali Sevk",
    ],
  },
